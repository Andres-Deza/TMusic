                ...
                <div class="col-12 col-lg-8">
                    <div class="login-content">
                        ...
                        <div class="login-form">
                            ...
                            <div class="container">
                                <asp:LinkButton ID="lnkAgregarBandas" CausesValidation="false" runat="server" OnClick="lnkAgregarBandas_Click">AgregarBandas</asp:LinkButton>
                            </div>
                            <div class="container">
                                <asp:LinkButton ID="lnkAgregarSolista" CausesValidation="false" runat="server" OnClick="lnkAgregarSolista_Click">Agregar Solista</asp:LinkButton>
                            </div>

                            <div class="container">
                                <asp:LinkButton ID="lnkAgregarAdmin" CausesValidation="false" runat="server" OnClick="lnkAgregarAdmin_Click">Agregar Admin</asp:LinkButton>
                            </div>
                            <div class="container">
                                <asp:LinkButton ID="lnkAgregarAvisos" CausesValidation="false" runat="server" OnClick="lnkAgregarAvisos_Click">Agregar Avisos</asp:LinkButton>
                            </div>
                        </div>
