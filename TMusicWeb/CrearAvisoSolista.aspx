<%@ Page Title="" Language="C#" MasterPageFile="~/SesionIniciadaSolista.Master" AutoEventWireup="true" CodeBehind="CrearAvisoSolista.aspx.cs" Inherits="TMusicWeb.CrearAvisoSolista" %>
                    ...
                    <div class="login-content">
                        ...
                        <div class="login-form">
                            ...
                            <div class="form-group">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ControlToValidate="txtmarca" runat="server" ErrorMessage="Campo requerido" ForeColor="Red"></asp:RequiredFieldValidator>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" ControlToValidate="txtprecio" runat="server" ErrorMessage="Campo requerido" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
                            ...
                            <div class="form-group">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ControlToValidate="ddlRegion" runat="server" ErrorMessage="Campo requerido" ForeColor="Red"></asp:RequiredFieldValidator>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" ControlToValidate="txtDescripcion" runat="server" ErrorMessage="Campo requerido" ForeColor="Red"></asp:RequiredFieldValidator>
                            </div>
