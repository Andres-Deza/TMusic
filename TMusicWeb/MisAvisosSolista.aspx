<%@ Page Title="" Language="C#" MasterPageFile="~/SesionIniciadaSolista.Master" AutoEventWireup="true" CodeBehind="MisAvisosSolista.aspx.cs" Inherits="TMusicWeb.MisAvisosSolista" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="oneMusic-buy-now-area has-fluid bg-gray section-padding-100">
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            ...
            <asp:GridView CssClass="table-responsive" ID="grdMisavisos" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" Height="140px" Width="596px">
