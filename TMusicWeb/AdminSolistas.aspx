<%@ Page Title="" Language="C#" MasterPageFile="~/MaestraAdmin.Master" AutoEventWireup="true" CodeBehind="AdminSolistas.aspx.cs" Inherits="TMusicWeb.AdminSolistas" %>
        ...
        <div class="container-fluid">
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    ...
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" ControlToValidate="txtBuscar" 
                        ValidationExpression="^\d+$" runat="server" ErrorMessage="Formato de ID erróneo" Display="Dynamic">
                    ...
                    <asp:GridView  ID="grdSolistas" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" Height="155px" Width="694px">
